<div class="card">
   ...
   <div class="card-body">
        ...
        <hr>
        <h4 class="lead">Fonte pagadora/Exames</h4>
        <div class="row">
            @include('templates.components.select',    ['label' => 'Convênio',               'col' => '4',  'select' => 'covenant',     'selected' => $personHasCollect->covenant   ?? null,   'attributes' => ['id' => 'selectCovenant', 'onchange' => 'activeEnrollment()', 'class' => 'form-control'], 'data' => $covenant_list])
            @include('templates.components.input',     ['label' => 'Matrícula/Carteirinha',  'col' => '4',  'input'  => 'enrollment',   'value'    => $personHasCollect->enrollment ?? null,   'attributes' => ['id' => 'inputEnroll', 'required' => 'true', 'class' => 'form-control', 'disabled' => 'true', 'maxlength' => 30]])
            @include('templates.components.textarea',  ['label' => 'EXAMES',                 'col' => '10', 'input'  => 'exams',        'value'    => $personHasCollect->exams      ?? null,   'attributes' => ['id' => 'textExams',  'required' => 'true', 'class' => 'form-control', 'rows' => '2', 'maxlength' => 20000]])
        </div>
        <hr>
        <div class="row">
