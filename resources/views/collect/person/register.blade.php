<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            {{-- linha --}}
            @include('templates.components.input',  ['label' => 'Outro contato',      'col' => '4', 'input'  => 'otherFone', 'attributes' => ['class'    => 'form-control']])
        ...
        <h4>Responsável</h4>
        <div class="row">
            @include('templates.components.select', ['label' => 'Tipo',     'col' => '4', 'select' => 'patientTypes_id',  'attributes' => ['class' => 'form-control', 'style' => 'width: 100%;', 'disabled'], 'data' => $patientType_list->pluck('name', 'id')])
            ...
            @include('templates.components.input',  ['label' => 'Contato ', 'col' => '4', 'input'  => 'foneReponsible',   'attributes' => ['required' => 'true', 'class' => 'form-control', 'disabled' => 'true']])
        </div>
        <hr>
        <div class="row">
